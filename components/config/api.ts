...
export const API_CONFIG = {
  ...
  ENDPOINTS: {
    ...
    PATIENT_CREATE: `${API_BASE_URL}/api/patients/create/`,
    ...
    MEDICAL_HISTORY: `${API_BASE_URL}/api/patients/kasallik-tarixi/`,
    PATIENTS_SEARCH: `${API_BASE_URL}/api/patients/patientlar/`,
